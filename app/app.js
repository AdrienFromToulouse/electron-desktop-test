...
app.on('ready', function() {
  ...
  mainWindow = new BrowserWindow({
    ...
    "type": "toolbar",
    "title": "BandLab",
    "icon": "./assets/shared/logo-red.png",
    "node-integration": false
  });

  // Load BandLab.
  mainWindow.loadUrl('https://bandlab.com/', {
  ...
  // Open all non-target=_blank links externally which aren't BandLab
  mainWindow.webContents.on("will-navigate", function(event, url) {

    regex = /(blog.bandlab.com|bandlab.com)|www.facebook.com/;
    if (!url.match(regex)) {
      require('shell').openExternal(url);
      event.preventDefault();
    }
